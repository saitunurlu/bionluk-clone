<template>
  <div class="w-full h-full flex flex-col">
    <div class="grid grid-cols-12 border-b h-4/6 items-center">
      ...
      <div class="col-start-3 col-end-9 flex justify-center">
      ...
      <div  class="col-start-9 col-end-13 flex items-center">
        ...
        <div class="relative flex justify-center">
          ...
          <Dropdown title="Bildirimler" :isShow="isNotificationDropdownShow" />
        </div>

        <div  class="px-5 py-3 border-l border-gray-300 flex justify-center gap-2 items-center">
          ...
          <Dropdown :isShow="isAccountDropdownShow" :title="username" class="mt-5" />
        </div>
