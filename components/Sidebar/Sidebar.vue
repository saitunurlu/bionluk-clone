      ...
      <ul class="space-y-2">
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Siparişlerim</span>
            <span
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Hizmet Alan İsteklerim</span>
            <span
        ...
        <li>
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Favorilerim</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="flex-1 ml-3 whitespace-nowrap">Cüzdanım</span>
          </a>
        </li>

      </ul>
      <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700" >
        <label class=" flex flex-auto font-bold text-1xl ml-2 ">Hizmet Veren</label>
        <li>
          <a
            href="#"
          ...
          >
            ...
            <span class="ml-4">İlanlarım</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="ml-3">Portfolyom</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="ml-3">Satışlarım</span>
          </a>
        </li>
